    ...
    <div class="menu-nav">
        <div>
            <span class="btn btn-pill btn-sm btn-primary">
                <i class="fas fa-home"></i> <i class="fas fa-chevron-right"></i> 재고관리 <i class="fas fa-chevron-right"></i> 자재수불부
            </span>
        </div>
...
<script>
    ...
    function getData()
    {
        ...
        $.ajax({
            url: "/mes/material/part/prodPartList"
            ,type: "post"
            ,headers: {
            ...
            .done(function (data)
            {
                ...
                data.forEach((item, index) => {
                    ...
                    node.push("<div class='text-right'>" + IsEmpty(item.purchase_cnt.comma('2')) + " " + IsEmpty(item.prod_unit_nm) + "</div>");
                    node.push("<div class='text-right'>-" + IsEmpty(item.input_cnt.comma('2')) + " " + IsEmpty(item.prod_unit_nm) + "</div>");
