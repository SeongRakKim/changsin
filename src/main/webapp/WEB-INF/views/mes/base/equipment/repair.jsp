    ...
    <div class="menu-nav">
        <div>
            <span class="btn btn-pill btn-sm btn-primary">
                <i class="fas fa-home"></i> <i class="fas fa-arrow-circle-right"></i> 기준정보 <i class="fas fa-arrow-circle-right"></i> 권한정보
            </span>
        </div>
...
<script>
            ...
            if($("#pop_snsr_cd").val().length > 3)
            {
                ...
                .done(function (data)
                {
                    if(data) {
                        ...
                        $(".invalid-feedback").text("중복된 권한 코드입니다.");
                    }else {
    ...
    function getDataOne(snsr_cd)
    {
        ...
        $.ajax({
            url: "/mes/base/sensor/snsrOne2/" + snsr_cd
            ,type: "get"
            ,dataType: "json"
            // ,data: JSON.stringify({})
        })
