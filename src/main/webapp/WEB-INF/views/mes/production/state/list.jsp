    ...
    <div class="menu-nav">
        <div>
            <span class="btn btn-pill btn-sm btn-primary">
                <i class="fas fa-home"></i> <i class="fas fa-chevron-right"></i> 생산관리 <i class="fas fa-chevron-right"></i> 작업지시
            </span>
        </div>
...
<script>
    ...
    function getDataOne(plan_cd)
    {
        ...
        $.ajax({
            url: "/mes/production/state/stateOne/" + plan_cd
            ,type: "get"
            ,dataType: "json"
            // ,data: JSON.stringify({})
        })
    ...
    function registData()
    {
        ...
        $.ajax({
            type: "post"
            ,url: "/mes/production/state/stateRegist"
            ,headers: {
                "Content-Type": "application/json"
                ,"X-HTTP-Method-Override": "POST"
            }
    ...
    function modifyData()
    {
        ...
        $.ajax({
            type: "post"
            ,url: "/mes/production/state/stateModify"
            ,headers: {
                "Content-Type": "application/json"
                ,"X-HTTP-Method-Override": "POST"
            }
    ...
    function deleteData()
    {
        ...
        $.ajax({
            type: "delete"
            ,url: "/mes/production/state/statePackDelete"
            ,headers: {
                "Content-Type": "application/json"
    ...
    function getPlanProcData(plan_cd)
    {
        ...
        $.ajax({
            url: "/mes/production/state/process/stateProcList"
            ,type: "post"
            ,headers: {
                "Content-Type": "application/json"
                ,"X-HTTP-Method-Override": "POST"
        ...
        else
        {
            Swal.fire({
                ...
                if (result.isConfirmed)
                {
                    ...
                    $.ajax({
                        type: "delete"
                        ,url: "/mes/production/state/process/stateProcDelete"
                        ,headers: {
                            "Content-Type": "application/json"
                            ,"X-HTTP-Method-Override": "DELETE"
                        }
