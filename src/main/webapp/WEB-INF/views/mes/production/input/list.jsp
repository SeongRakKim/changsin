    ...
    <div class="menu-nav">
        <div>
            <span class="btn btn-pill btn-sm btn-primary">
                <i class="fas fa-home"></i> <i class="fas fa-arrow-circle-right"></i> 생산관리 <i class="fas fa-arrow-circle-right"></i> 생산투입이력
            </span>
        </div>
        ...
        $.ajax({
            ...
            .done(function (data)
            {
                ...
                data.forEach((item, index) => {
                    ...
                    node.push(IsEmpty(item.prod_ja_pn));
                    node.push(IsEmpty(item.prod_ja_nm));
                    node.push(IsEmpty(item.prod_ja_kind_nm));
                    // node.push(IsEmpty(item.prod_ja_group_nm));
                    node.push(IsEmpty(item.prod_ja_stand));
                    node.push("<div class='text-center'>" + IsEmpty(item.plan_input_indate) + "</div>");
                    node.push("<div class='text-right'>" + IsEmpty(item.plan_res_cnt.comma('2')) + " " + IsEmpty(item.prod_unit_nm) + "</div>");
                    node.push("<div class='text-right'>" + IsEmpty(item.plan_bom_cnt.comma('6')) + " " + IsEmpty(item.prod_unit_nm) + "</div>");
                    node.push("<div class='text-right'>" + IsEmpty(item.plan_input_cnt.comma('6')) + " " + IsEmpty(item.prod_unit_nm) + "</div>");
