    ...
    <div class="menu-nav">
        <div>
            <span class="btn btn-pill btn-sm btn-primary">
                <i class="fas fa-home"></i> <i class="fas fa-arrow-circle-right"></i> 생산관리 <i class="fas fa-arrow-circle-right"></i> 생산비가동이력
            </span>
        </div>
        ...
        $.ajax({
            ...
            .done(function (data)
            {
                ...
                data.forEach((item, index) => {
                    ...
                    node.push("<div class='text-center'>" + IsEmpty(item.plan_stop_stdt) + "</div>");
                    node.push("<div class='text-center'>" + IsEmpty(item.plan_stop_eddt) + "</div>");
                    node.push("<div class='text-center'>" + IsEmpty(item.plan_stop_item_nm) + "</div>");
                    node.push("<div class='text-center red'>" + IsEmpty(item.plan_stop_time) + "분</div>");
