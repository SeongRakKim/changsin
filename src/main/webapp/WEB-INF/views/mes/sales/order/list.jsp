...
<script id="popOrderTemplete" type="text/x-handlebars-template">
    <tr class="dataList list_tr{{cnt}}">
        ...
        <td>{{odr_dt}}</td>
        <td>{{odr_ship_dt}}</td>
        <td style="text-align: right !important;">{{odr_cnt}}</td>
        <td style="text-align: right !important;">{{odr_price}}</td>
        <td style="text-align: right !important;">{{odr_amt}}</td>
        <td style="text-align: right !important;">{{odr_vat}}</td>
        <td>
