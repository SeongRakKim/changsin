    ...
    $.fn.numpad = function (options) {
        ...
        return this.each(function () {
            ...
            if ($('#' + id).length == 0) {
                ...
                nmpd.grid = table;
                table.append(
                    $(options.rowTpl).append(
                        $(options.displayCellTpl)
                            .append(display)
                ...
                table
                    .append(
                        $(options.rowTpl)
                            ...
                            .append(
                                $(options.cellTpl).append(
                                    $(options.buttonFunctionTpl)
                                        .html(options.textDelete)
                                        .addClass('del')
                                        .click(function () {
                                            nmpd.setValue(
                                                nmpd
                                                    .getValue()
                                                    .toString()
                                                    .substring(0, nmpd.getValue().toString().length - 1),
                                            );
                                        }),
                                ),
                            ),
                    ...
                    .append(
                        $(options.rowTpl)
                            .append(
                                $(options.cellTpl).append(
                                    $(options.buttonFunctionTpl)
                                        .html(options.dotSeparator)
                                        .addClass('dot')
                                        .click(function () {
                                            nmpd.setValue(nmpd.getValue().toString() + options.dotSeparator);
                                        }),
                                ),
                            )
                            // .append(
                            ...
                            .append(
                                $(options.cellTpl).append(
                                    $(options.buttonFunctionTpl).html(options.textDone).addClass('done'),
                                ),
                            ),
                    );
                // Create the backdrop of the numpad - an overlay for the main page
                nmpd.append(
                    $(options.backgroundTpl)
                        .addClass('nmpd-overlay')
                        .click(function () {
                            nmpd.close(false);
                        }),
                );
