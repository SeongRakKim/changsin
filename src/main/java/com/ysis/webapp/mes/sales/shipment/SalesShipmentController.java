...
public class SalesShipmentController {
    ...
    @GetMapping("/mes/sales/shipment/list")
    ...
    @GetMapping("/mes/sales/shipment/state")
    public void state(VMap vmap, Model model, HttpServletRequest httpServletRequest) throws Exception {
        vmap.put("requestUri", httpServletRequest.getRequestURI());
